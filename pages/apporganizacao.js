...
cardtitle.innerText = 'Organizadores';
CARD_CONTAINER.appendChild(cardtitle); 

var ref = firebase.database().ref('conteudo').child('organizacao');
/**
...
function adicionaCardATela(informacao, id) {
    ...
    nnimage.innerText = "Nome imagem: "+informacao.imagem;
    // ===================================
